# -*- coding: utf-8 -*-
caffe_root = "d:\\caffe\\"      #caffe安装目录            linux系统注释掉这一行
root = "E:/pyprject/faceapi-github/Face-recognition-test/"  #项目根目录
import sys
sys.path.insert(0, caffe_root + 'python')                #linux 系统注释掉这一行
import random
import skimage
import numpy as np
import os
